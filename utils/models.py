...
def get_seq_nn_model(
    input_dim: int,
    num_nodes: int = param_num_nodes,
    dropout_rate: float = param_dropout_rate,
    l1_v: float = param_l1_v,
    ...
    # output layer
    model.add(
        Dense(units=configs["number_of_classes"], activation=configs["activation"])
    )
    return model
